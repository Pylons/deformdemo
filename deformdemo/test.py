...
class SequenceOfSelects(Base, unittest.TestCase):
    url = "/sequence_of_selects_with_initial_item_and_default/"
    def test_render_default(self):
        browser.open(self.url)
        browser.wait_for_page_to_load("30000")
        self.assertEqual(browser.get_text('deformField1-addtext'),
    ...
    def test_submit_initial_item_default(self):
        browser.open(self.url)
        browser.wait_for_page_to_load("30000")
        browser.click("submit")
        browser.wait_for_page_to_load("30000")
    ...
    def test_submit_added_item_default(self):
        browser.open(self.url)
        browser.wait_for_page_to_load("30000")
        browser.click('deformField1-seqAdd')
        browser.click("submit")
